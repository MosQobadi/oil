...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div
        className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-accent/10 blur-3xl animate-pulse"
            ...
            >
              <Link href="/products">
                ...
                >
                  ...
                  <ArrowRight
                    className={`h-4 w-4 group-hover:translate-x-1 transition-transform ${isRTL ? "mr-2 rotate-180" : "ml-2"}`}
                  />
                </Button>
              </Link>
              <Button
              ...
              >
                <Play
                  className={`h-4 w-4 group-hover:scale-110 transition-transform ${isRTL ? "ml-2" : "mr-2"}`}
                />
                {t.hero.watchStory}
              </Button>
            </motion.div>
                  ...
                  <div className="w-64 h-80 relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-secondary via-card to-secondary rounded-3xl border border-border/50 overflow-hidden">
                      ...
                      <div className="absolute inset-x-4 top-16 bottom-20 bg-gradient-to-br from-primary/20 to-primary/5 rounded-xl border border-primary/30 flex flex-col items-center justify-center p-4">
                        ...
                        <div className="text-muted-foreground text-[10px] tracking-wider mt-1">
                          FULL SYNTHETIC
                        </div>
                      </div>
                      {/* Cap */}
